// MongoDB Assignment 3 - Retail Store Inventory & Sales
use retailStoreDB;
// Insert Sample Data
...
// Aggregation & Join-style Queries
...
// 7. Display total revenue (price × quantity) per product.
db.sales.aggregate([
  {
    $lookup: {
      from: "products",
...
// 10. Find top 2 best-selling products based on quantity.
db.sales.aggregate([
  {
    $group: {
      _id: "$product_id",
