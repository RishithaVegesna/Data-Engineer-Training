...
-- 5. Show each traveler’s name, destination city, and total trip cost 
...
-- 10. Find the trip that had the highest cost per day 
...
-- 12. Delete trips that ended before January 1, 2023 
DELETE FROM Trips
WHERE trip_id IN (
  SELECT trip_id FROM (
